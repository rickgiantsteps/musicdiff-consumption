...
for k in range(runs):
    ...
    tracker = EmissionsTracker(project_name=f"MusicGenSmall-inference", tracking_mode="process", gpu_ids="0",
                                output_dir="../../../results/inference_steps/MusicGen",
                                output_file=f"MusicGenSmall-emissions-run{k+1}.csv", allow_multiple_runs=True)
    ...
    scipy.io.wavfile.write(f"genaudios/MusicGenSmall.wav",
