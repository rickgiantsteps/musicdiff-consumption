...
for k in range(runs):
    ...
    tracker = EmissionsTracker(project_name=f"MagnetSmall-inference", tracking_mode="process", gpu_ids="0",
                                output_dir="../../../results/inference_steps/Magnet",
                                output_file=f"MagnetSmall-emissions-run{k+1}.csv", allow_multiple_runs=True)
    ...
    for idx, one_wav in enumerate(wav):
       audio_write("genaudios/MagnetSmall", one_wav.cpu(), model.sample_rate, strategy="loudness")
